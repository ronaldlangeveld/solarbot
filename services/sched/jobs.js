...
const updateSolarData = cron.schedule('*/1 * * * * ', async () => {
    const {gridFrequencyLatest, gridFrequencyNow, batteryLevelNow, sunPower, consumptionNow, hasChanged} = await testPower();
